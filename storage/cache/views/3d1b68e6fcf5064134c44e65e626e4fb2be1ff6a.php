        ...
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                <?php if(count($stores) > 0): ?>
                    ...
                    <tr>
                        <td><?php echo e($store->getKey()); ?></td>
                        <td><?php echo e($store->name); ?></td>
                        <td><?php echo e($store->address); ?></td>
                        <td class="actions">
                            <a class="btn btn-success btn-xs" href="/edit/<?php echo e($store->getKey()); ?>">edit</a>
                            <button class="btn btn-danger btn-xs" onclick="setStore(<?php echo e($store->getKey()); ?>)"
...
<?php echo $__env->make('template', ['title' => 'Stores'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\php\mirum-framework\views/store/index.blade.php ENDPATH**/ ?>